  ...
  if (el) {
    const texts = {
      ...
      cape: {
        ...
        description: "Ignore les dégâts subis par la prochaine attaque directe de l'adversaire."
      },
      armure: {
        alt: "Armure de Fer",
        title: "Armure de Fer",
      ...
      crystal: {
        ...
        description: "Recharge instantanément 0.8 points de la capacité spéciale."
      }
    };
